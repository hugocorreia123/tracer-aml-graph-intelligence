...
- [ ] **Phase 1 — Tabular baseline**: per-account features → LightGBM, PR-AUC (the honest control the GNN must beat)
- [ ] **Phase 2 — First GNN**: GraphSAGE node classifier vs. baseline on the same split
